...
version without pools api and with VAULT new error handling for server not found
"""
...
def get_headers():
	...
	"""
	vault = apivault.init_server() 

	headers = {
		"Content-Type":"application/json",
		"X-Auth-User": vault['user'],
		"X-Auth-Key": vault['password']
